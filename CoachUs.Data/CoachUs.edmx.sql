...
-- --------------------------------------------------
-- Date Created: 06/01/2015 17:21:46
...
GO
IF OBJECT_ID(N'[dbo].[FK_ActivityCategoryActivity]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Activities] DROP CONSTRAINT [FK_ActivityCategoryActivity];
GO
...
ALTER TABLE [dbo].[EventGallery]
ADD CONSTRAINT [FK_EventGallery_Event]
...
ALTER TABLE [dbo].[EventGallery]
ADD CONSTRAINT [FK_EventGallery_File]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_EventGallery_File'
CREATE INDEX [IX_FK_EventGallery_File]
ON [dbo].[EventGallery]
    ([Files_ID]);
GO
...
ALTER TABLE [dbo].[Activities]
ADD CONSTRAINT [FK_ActivityCategoryActivity]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_ActivityCategoryActivity'
CREATE INDEX [IX_FK_ActivityCategoryActivity]
ON [dbo].[Activities]
    ([ActivityCategoryId]);
GO
